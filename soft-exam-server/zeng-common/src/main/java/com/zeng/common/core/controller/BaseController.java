package com.zeng.common.core.controller;
...
public class BaseController {
     ...
     * @return 操作结果
     */
    protected ResponseBean toAjax(int rows) {
        return rows > 0 ? ResponseBean.success() : ResponseBean.error();
    }
     ...
     * @return 操作结果
     */
    protected ResponseBean toAjax(boolean result) {
