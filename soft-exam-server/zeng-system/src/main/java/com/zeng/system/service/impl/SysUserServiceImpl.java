package com.zeng.system.service.impl;

import com.zeng.common.annotation.DataScope;
...
import com.zeng.system.domain.SysPost;
import com.zeng.system.domain.SysUserPost;
import com.zeng.system.domain.SysUserRole;
import com.zeng.system.mapper.*;
...
public class SysUserServiceImpl implements ISysUserService {
    ...
    public List<SysUser> selectUserList(SysUser user) {
        if(SecurityUtils.getLoginUser().getPermissions().equals('*')){
            return userMapper.selectUserList(user);
        }else {
            List<SysUser> sysUserList = userMapper.selectUserList(user);
            List<SysUser> sysUsers = sysUserList.stream().filter(item -> item.getUserName().indexOf("admin") < 0).collect(Collectors.toList());
            return sysUsers;
        }
    }
    ...
    @Override
    public SysUser selectNickName(String nickName) {
